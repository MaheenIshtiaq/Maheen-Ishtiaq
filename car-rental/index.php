      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>Aap Ki Sahulat, Hamari Zimmedari</p>
        </div>
      </div>
    </div>
  </div>
...
<style>/* Ensures that all vehicle images are cropped to fit the container */
.recent-car-list img {
...
/* Ensures the car info box and images inside each widget have the same size */
.recent-car-list {
    display: flex;
    flex-direction: column;
    justify-content: space-between;
    height: 400px; /* Adjust the height to ensure all widgets are the same height */
}

/* Ensures images are cropped to the same size and fit within the container */
.recent-car-list img {
    width: 100%;
...
/* Makes sure all car widgets align properly and the content is consistent */
.col-list-3 {
    padding: 15px;
